...
<script src="https://cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.min.js"></script>
    ...
    <div class="row">
            ...
            <div class="card" style="background-color: rgb(13 148 136); color: #fff">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <p class="fs-4">Today Booking <br> <?= number_format($todayTotalPrice, 0, ".", "."); ?>đ</p>
                        <div class="row text-xs" style="font-size: 11px;">
                            <div class="col-4 ">Booked-Booking <br> {{ $todayCompletedCounts }}</div>
                            <div class="col-4 ">Pending-Booking <br> {{ $todayPendingCounts }}</div>
                            <div class="col-4 ">Canceled-Booking <br> {{ $todayCanceledCounts }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card" style="background-color: rgb(251 146 60); color: #fff">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <p class="fs-4">Yesterday Booking <br><?= number_format($yesterdayTotalPrice, 0, ".", "."); ?>đ</p>
                        <div class="row text-xs" style="font-size: 11px;">
                            <div class="col-4 ">Booked-Booking <br> {{ $yesterdayCompletedCounts }}</div>
                            <div class="col-4 ">Pending-Booking <br> {{ $yesterdayPendingCounts }}</div>
                            <div class="col-4 ">Canceled-Booking <br> {{ $yesterdayCanceledCounts }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col ">
            <div class="card" style="background-color: rgb(59 130 246); color: #fff; height: 191px">
                <div class="card-body justify-content-between">
                    ...
                    <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p class="fs-3">This month <br> <?= number_format($thisMonthTotalPrice, 0, ".", "."); ?>đ</p>
        ...
        <div class="col ">
            <div class="card" style="background-color: rgb(8 145 178); color: #fff; height: 191px">
                <div class="card-body justify-content-between">
                    <div class="text-center fs-2">
                    <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle>
                        ...
                        <p class="fs-3">Last month <br> <?= number_format($lastMonthTotalPrice, 0, ".", "."); ?>đ</p>
        ...
        <div class="col ">
            <div class="card" style="background-color: rgb(5 150 105); color: #fff; height: 191px">
                <div class="card-body justify-content-between">
                    <div class="text-center fs-2">
                    <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle>
                        ...
                        <p class="fs-3">Total All <br> <?= number_format($totalPrice, 0, ".", "."); ?>đ</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mt-2 mb-2">
        ...
        <div class="col-2">
            ...
            <button type="submit" class="btn btn-success w-100 btn-dashboard-filter" id="btn-dashboard-filter">Filler</button>
        </div>
        <div class="col-2">
            <label class="form-label">.</label>
