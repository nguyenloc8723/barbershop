...
@section('content')
                    ...
                    <div class="row justify-content-between">
                        <div class="col-md-4">
                            <div class="mt-3 mt-md-0">
                                <a href="{{route('route.service-combo')}}" class="btn btn-warning"> Quay lại</a>
                                <button type="button" class="btn btn-success waves-effect waves-light query-btn-show-modal"><i
                ...
                <div class="card-body">
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap text-center align-content-sm-center">
                        ...
                        <tr>
                            ...
                            <td>100 củ khoai</td>
                            <td>
                                <img src="{{asset('be/img/user-13.jpg')}}"  class="rounded-circle img-thumbnail avatar-xl">
                            </td>
                            <td class="text-center">
                                ...
                                <div class="btn-group dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <button class="dropdown-item btn-update" data-bs-toggle="modal" data-bs-target="#update-modal"><i class="mdi mdi-pencil me-2 text-muted font-18 vertical-middle"></i>Cập nhật</button>
    ...
    <div class="modal fade show jq-main-modal" id="create-modal" tabIndex="-1" style="display: block;" aria-hidden="true">
