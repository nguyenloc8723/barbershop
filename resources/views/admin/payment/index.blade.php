                ...
                <div class="row justify-content-between">
                    <div class="col-md-4">
                        <div class="mt-3 mt-md-0">
                                ...
                                <button class="btn btn-success waves-effect waves-light jquery-btn-create"> Đơn hàng thanh toán online
                                </button>
                ...
                <div class="row">
                    ...
                    <form action="{{route('searchPayment')}}" method="POST">
                            ...
                            <div class="input-group mb-4 border rounded-pill p-1">
                                ...
                                <input type="search" placeholder="What're you searching for?" aria-describedby="button-addon4" class="form-control bg-none border-0" name="searchPayment">
