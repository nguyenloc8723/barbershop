<div class="left-side-menu">
    ...
    <div class="h-100" data-simplebar>
        ...
        <div class="user-box text-center">
            <div class="dropdown">
                <a href="{{ route('route.dashboard') }}" class="user-name dropdown-toggle h5 mt-2 mb-1 d-block"
                    data-bs-toggle="dropdown" aria-expanded="false">6XPRO + 1</a>
        ...
        <div id="sidebar-menu">
            <ul id="side-menu">
                ...
                <li>
                    @if (\Gate::check('roles.indexMember'))
                ...
                <li>
                    @if (\Gate::check('roles.indexBanner'))
