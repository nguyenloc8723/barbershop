                ...
                <div class="noti-scroll" data-simplebar>
                    ...
                    <div class="dropdown-item notify-item" style="background-color: none">
                        ...
                        <a class="col-12" @if($item->messege === 'Thông báo có lịch đặt mới.') href="{{route('route.booking_blade')}}" @else href="{{route('review.index')}}" @endif >
                            ...
                            --}}
                            {{-- <span style="bottom: 35px; position: relative; display: flex; justify-content: flex-end; align-items: center;" id="noti-latest-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" style="color: #696cff;" width="14" height="14" fill="currentColor" class="bi bi-circle-fill" viewBox="0 0 16 16">
