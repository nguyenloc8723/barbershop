            ...
            <div class="card-body">
                <div class="row justify-content-between">
                    <div class="col-md-4">
                        ...
                        <a href="{{ route('timesheets.create') }}" class="btn btn-primary">Setting</a>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap text-center align-content-sm-center">
                    ...
                    <td>{{ $setting->key }}</td>
                    <td>{{ $setting->value }}</td>
                    <td>  <a href="{{ route('settings.edit', ['id' => $timesheet->id]) }}" class="btn btn-warning">Edit</a>


                    <a href="{{ route('settings.delete', ['id' => $timesheet->id]) }}" class="btn btn-danger">Delete</a>
                    </td>
