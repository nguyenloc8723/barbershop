            ...
            <div class="card-body">
                <div class="row justify-content-between">
                    <div class="col-md-4">
                        ...
                        <a href="{{ route('pricings.create') }}" class="btn btn-primary">Add chính sách</a>


                            {{-- <a href="{{route('timesheet.create')}}" class="btn btn-success waves-effect waves-light"--}}
                            {{-- ><i--}}
                            {{-- class="mdi mdi-plus-circle me-1"></i> Thêm pricing--}}
                            {{-- </a>--}}
                        </div>
                    </div>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap text-center align-content-sm-center">
                    ...
                    <td>
            <button type="button" class="btn btn-primary"><a style="color: white; text-decoration: none;" href="{{route('pricings.edit',$pricing->id)}}">Sửa pricing</a></button>
            <form action="{{route('pricings.destroy',$pricing->id)}}" method="POST">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn btn-danger">Xoá pricing</button>
                </form>
        </td>
