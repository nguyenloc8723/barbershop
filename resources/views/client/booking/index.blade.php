                    ...
                    <div class="main-screen">
                        ...
                        <div class="main-screen__block main-screen__block--active">
                            ...
                            <div class="block" id="service-time">
                                ...
                                <button type="button" role="switch" aria-checked="true" class="ant-switch advice-extension__switch ant-switch-checked" ant-click-animating="true"><div class="ant-switch-handle"></div><span class="ant-switch-inner"></span><div class="ant-click-animating-node"></div></button>
                            </div>
                        </div>
                    </div>
