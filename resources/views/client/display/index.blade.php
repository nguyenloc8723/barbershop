...
<style>
    ...
    .v-middle {
        ...
        height: 100vh;
        /* Điều này làm cho div trải đều trên chiều cao của trình duyệt */
    }
                ...
                <div class="v-middle">
                    ...
                    <div class="home__form-input">
                        <div class="form-input__slogan">
                            <div class="slogan__title title_top">Đặt lịch giữ chỗ chỉ 30 giây</div>
                            <div class="slogan__text">Cắt xong trả tiền, hủy lịch không sao</div>
                        </div>
                        <div class="form-input__form flex mt-1">
                            <div class="form__input">
                                <input type="tel" id="phone-number" placeholder="Nhập SĐT để đặt lịch" class="my-input" pattern="[0-9]{10}" required>
                            </div>
                            <div class="form__button btn-action content-center-middle" role="presentation">
                                <button class="form-link" id="book-appointment">ĐẶT LỊCH NGAY<span></span></button>
                            </div>
                        </div>
...
<script>
    document.getElementById("book-appointment").addEventListener("click", function(event) {
        ...
        if (!/^\d{10}$/.test(phoneNumber)) {
            ...
            window.location.href = '/user/booking?user_phone=' + phoneNumber;
        }
