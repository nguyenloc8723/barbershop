                ...
                <div class="row justify-content-between">
                    <div class="col-md-4">
                        ...
                        <a href="{{ route('faqs.create') }}" class="btn btn-primary">Thêm câu hỏi</a>
                            ...
                            {{-- ><i--}}
                            {{-- class="mdi mdi-plus-circle me-1"></i> Thêm faq--}}
                            {{-- </a>--}}
                        </div>
                    </div>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap text-center align-content-sm-center">
                    ...
                    <td>
            <button type="button" class="btn btn-primary"><a style="color: white; text-decoration: none;" href="{{route('faqs.edit',$faq->id)}}">Sửa câu hỏi</a></button>
            <form action="{{route('faqs.destroy',$faq->id)}}" method="POST">
                @csrf
                @method('DELETE')
                <button type="submit" class="btn btn-danger">Xoá câu hỏi</button>
                </form>
        </td>
