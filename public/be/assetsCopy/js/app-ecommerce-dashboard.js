...
//     var d = document.querySelector("#visitorsChart"), c = {
...
//         },
//         yaxis: {labels: {show: !1}}
//     }, d = (null !== d && new ApexCharts(d, c).render(), document.querySelector("#activityChart")), c = {
...
//         fill: {
//             type: "gradient",
//             gradient: {shade: t, shadeIntensity: .8, opacityFrom: .8, opacityTo: .25, stops: [0, 85, 100]}
//         },
...
//         },
//         yaxis: {labels: {show: !1}}
//     }, d = (null !== d && new ApexCharts(d, c).render(), document.querySelector("#profitChart")), c = {
...
//         },
//         yaxis: {labels: {show: !1}}
//     }, d = (null !== d && new ApexCharts(d, c).render(), document.querySelector("#expensesChart")), c = {
...
//                 dataLabels: {name: {show: !1}, value: {fontSize: "22px", color: e, fontWeight: 500, offsetY: 0}}
//             }
//         },
//         grid: {show: !1, padding: {left: -10, right: -10, top: -10}},
//         stroke: {lineCap: "round"},
//         labels: ["Progress"]
//     }, d = (null !== d && new ApexCharts(d, c).render(), document.querySelector("#totalIncomeChart")), c = {
//         chart: {
//             height: 250,
//             type: "area",
//             toolbar: !1,
//             dropShadow: {enabled: !0, top: 14, left: 2, blur: 3, color: config.colors.primary, opacity: .15}
//         },
...
//         fill: {
//             type: "gradient",
//             gradient: {shade: t, shadeIntensity: .8, opacityFrom: .7, opacityTo: .25, stops: [0, 95, 100]}
//         },
//         grid: {show: !0, borderColor: s, padding: {top: -15, bottom: -10, left: 0, right: 0}},
//         xaxis: {
...
//         yaxis: {
//             labels: {
//                 offsetX: -15, formatter: function (o) {
//                     return "$" + parseInt(o / 1e3) + "k"
//                 }, style: {fontSize: "13px", colors: r}
//             }, min: 1e3, max: 6e3, tickAmount: 5
//         }
//     }, d = (null !== d && new ApexCharts(d, c).render(), document.querySelector("#performanceChart")), c = {
//         series: [{name: "Income", data: [26, 29, 31, 40, 29, 24]}, {
//             name: "Earning",
...
//             type: "radar",
//             toolbar: {show: !1},
//             dropShadow: {enabled: !0, enabledOnSeries: void 0, top: 6, left: 0, blur: 6, color: "#000", opacity: .14}
//         },
...
//             labels: {show: !0, style: {colors: [r, r, r, r, r, r], fontSize: "13px", fontFamily: "Public Sans"}}
//         },
//         yaxis: {show: !1, min: 0, max: 40, tickAmount: 4}
//     }, d = (null !== d && new ApexCharts(d, c).render(), document.querySelector("#conversionRateChart")), c = {
//         chart: {
//             height: 80,
//             width: 140,
//             type: "line",
//             toolbar: {show: !1},
//             dropShadow: {enabled: !0, top: 10, left: 5, blur: 3, color: config.colors.primary, opacity: .15},
//             sparkline: {enabled: !0}
//         },
//         markers: {
//             size: 6,
...
//         yaxis: {show: !1}
//     }, d = (null !== d && new ApexCharts(d, c).render(), document.querySelector("#expensesBarChart")), c = {
//         series: [{name: "2021", data: [15, 37, 14, 30, 38, 30, 20, 13, 14, 23]}, {
//             name: "2020",
//             data: [-33, -23, -29, -21, -25, -21, -23, -19, -37, -22]
//         }],
//         chart: {height: 150, stacked: !0, type: "bar", toolbar: {show: !1}},
//         plotOptions: {bar: {horizontal: !1, columnWidth: "40%", borderRadius: 5, startingShape: "rounded"}},
...
//     }, d = (null !== d && new ApexCharts(d, c).render(), document.querySelector("#totalBalanceChart")), c = {
...
//             parentWidthOffset: 0,
//             type: "line",
//             dropShadow: {enabled: !0, top: 10, left: 5, blur: 3, color: config.colors.warning, opacity: .15},
//             toolbar: {show: !1}
//         },
//         dataLabels: {enabled: !1},
