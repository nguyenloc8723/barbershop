...
//         }
//     };
//     var h = document.querySelectorAll(".chart-progress"), h = (h && h.forEach(function (o) {
//         var e = config.colors[o.dataset.color], r = o.dataset.series, e = {
...
//     }), document.querySelector("#customerRatingsChart")), p = {
//         chart: {
//             height: 200,
//             toolbar: {show: !1},
//             zoom: {enabled: !1},
...
//             }
//         },
//         series: [{name: "Last Month", data: [20, 54, 20, 38, 22, 28, 16, 19]}, {
//             name: "This Month",
...
//         grid: {show: !1, borderColor: s, padding: {top: -20, bottom: -10, left: 0}},
//         markers: {
//             size: 6,
//             colors: "transparent",
...
//         },
//         yaxis: {show: !1}
//     }, h = (null !== h && new ApexCharts(h, p).render(), document.querySelector("#salesActivityChart")), p = {
//         chart: {type: "bar", height: 275, stacked: !0, toolbar: {show: !1}},
//         series: [{name: "PRODUCT A", data: [75, 50, 55, 60, 48, 82, 59]}, {
//             name: "PRODUCT B",
...
//         responsive: [{
//             breakpoint: 1440,
//             options: {plotOptions: {bar: {borderRadius: 10, columnWidth: "50%"}}}
...
//             breakpoint: 992,
//             options: {plotOptions: {bar: {borderRadius: 12, columnWidth: "40%"}}, chart: {type: "bar", height: 320}}
...
//     }, h = (null !== h && new ApexCharts(h, p).render(), document.querySelector("#sessionsChart")), p = {
...
//         fill: {
//             type: "gradient",
//             gradient: {shade: a, shadeIntensity: .8, opacityFrom: .8, opacityTo: .25, stops: [0, 95, 100]}
//         },
//         dataLabels: {enabled: !1},
...
//         yaxis: {show: !1}
//     }, h = (null !== h && new ApexCharts(h, p).render(), document.querySelector("#leadsReportChart")), p = {
...
//             }
//         }
//     }, c = (null !== h && new ApexCharts(h, p).render(), document.querySelector("#reportBarChart")), h = {
...
//         },
//         yaxis: {labels: {show: !1}}
//     }, p = (null !== c && new ApexCharts(c, h).render(), document.querySelector("#salesAnalyticsChart")), c = {
//         chart: {height: 350, type: "heatmap", parentHeightOffset: 0, offsetX: -10, toolbar: {show: !1}},
//         series: [{
//             name: "1k",
//             data: [{x: "Jan", y: "250"}, {x: "Feb", y: "350"}, {x: "Mar", y: "220"}, {x: "Apr", y: "290"}, {
//                 x: "May",
//                 y: "650"
//             }, {x: "Jun", y: "260"}, {x: "Jul", y: "274"}, {x: "Aug", y: "850"}]
//         }, {
//             name: "2k",
//             data: [{x: "Jan", y: "750"}, {x: "Feb", y: "3350"}, {x: "Mar", y: "1220"}, {x: "Apr", y: "1290"}, {
//                 x: "May",
//                 y: "1650"
//             }, {x: "Jun", y: "1260"}, {x: "Jul", y: "1274"}, {x: "Aug", y: "850"}]
//         }, {
//             name: "3k",
//             data: [{x: "Jan", y: "375"}, {x: "Feb", y: "1350"}, {x: "Mar", y: "3220"}, {x: "Apr", y: "2290"}, {
//                 x: "May",
//                 y: "2650"
//             }, {x: "Jun", y: "2260"}, {x: "Jul", y: "1274"}, {x: "Aug", y: "815"}]
//         }, {
//             name: "4k",
//             data: [{x: "Jan", y: "575"}, {x: "Feb", y: "1350"}, {x: "Mar", y: "2220"}, {x: "Apr", y: "3290"}, {
//                 x: "May",
//                 y: "3650"
//             }, {x: "Jun", y: "2260"}, {x: "Jul", y: "1274"}, {x: "Aug", y: "315"}]
//         }, {
//             name: "5k",
//             data: [{x: "Jan", y: "875"}, {x: "Feb", y: "1350"}, {x: "Mar", y: "2220"}, {x: "Apr", y: "3290"}, {
//                 x: "May",
//                 y: "3650"
//             }, {x: "Jun", y: "2260"}, {x: "Jul", y: "1274"}, {x: "Aug", y: "965"}]
//         }, {
//             name: "6k",
//             data: [{x: "Jan", y: "575"}, {x: "Feb", y: "1350"}, {x: "Mar", y: "2220"}, {x: "Apr", y: "2290"}, {
//                 x: "May",
//                 y: "2650"
//             }, {x: "Jun", y: "3260"}, {x: "Jul", y: "1274"}, {x: "Aug", y: "815"}]
//         }, {
//             name: "7k",
//             data: [{x: "Jan", y: "575"}, {x: "Feb", y: "1350"}, {x: "Mar", y: "1220"}, {x: "Apr", y: "1290"}, {
//                 x: "May",
//                 y: "1650"
//             }, {x: "Jun", y: "1260"}, {x: "Jul", y: "3274"}, {x: "Aug", y: "815"}]
//         }, {
//             name: "8k",
//             data: [{x: "Jan", y: "575"}, {x: "Feb", y: "350"}, {x: "Mar", y: "220"}, {x: "Apr", y: "290"}, {
//                 x: "May",
//                 y: "650"
//             }, {x: "Jun", y: "260"}, {x: "Jul", y: "274"}, {x: "Aug", y: "815"}]
//         }],
//         plotOptions: {
//             heatmap: {
//                 enableShades: !1,
//                 radius: "6px",
//                 colorScale: {
//                     ranges: [{from: 0, to: 1e3, name: "1k", color: i}, {
//                         from: 1001,
//                         to: 2e3,
//                         name: "2k",
//                         color: n
//                     }, {from: 2001, to: 3e3, name: "3k", color: l}, {from: 3001, to: 4e3, name: "4k", color: d}]
//                 }
//             }
//         },
//         dataLabels: {enabled: !1},
...
//         responsive: [{
//             breakpoint: 1441,
//             options: {chart: {height: "325px"}, grid: {padding: {right: -15}}}
//         }, {breakpoint: 1045, options: {chart: {height: "300px"}, grid: {padding: {right: -50}}}}, {
//             breakpoint: 992,
//             options: {chart: {height: "320px"}, grid: {padding: {right: -50}}}
//         }, {breakpoint: 767, options: {chart: {height: "400px"}, grid: {padding: {right: 0}}}}, {
//             breakpoint: 568,
//             options: {chart: {height: "330px"}, grid: {padding: {right: -20}}}
//         }],
//         states: {hover: {filter: {type: "none"}}, active: {filter: {type: "none"}}}
//     }, h = (null !== p && new ApexCharts(p, c).render(), document.querySelector("#salesStats")), p = {
...
//                         formatter: function (o) {
//                             return parseInt(o) + "%"
//                         }, offsetY: 20, color: e, fontSize: "32px", show: !0
//                     }
//                 }
//             }
//         },
...
function drawSessionsChart() {
    ...
    let chartElement = document.querySelector("#sessionsChart");
...
function reportBarChart() {
    ...
    let chartElement = document.querySelector("#reportBarChart");

    if (chartElement) {
        new ApexCharts(chartElement, c).render();
    }
}


// -------------------------
function drawSalesAnalyticsChart() {
    let o, e, r, t, a, s, i, n, l, d;
    d = isDarkStyle ? (o = config.colors_dark.cardColor, e = config.colors_dark.headingColor, r = config.colors_dark.textMuted, t = config.colors_dark.bodyColor, s = config.colors_dark.borderColor, a = "dark", i = "#4f51c0", n = "#595cd9", l = "#8789ff", "#c3c4ff") : (o = config.colors.white, e = config.colors.headingColor, r = config.colors.textMuted, t = config.colors.bodyColor, s = config.colors.borderColor, a = "", i = "#e1e2ff", n = "#c3c4ff", l = "#a5a7ff", "#696cff");
    ...
    var c = {
        chart: { height: 350, type: "heatmap", parentHeightOffset: 0, offsetX: -10, toolbar: { show: !1 } },
        series: [
            { name: "1k", data: [{ x: "Jan", y: "250" }, { x: "Feb", y: "350" }, { x: "Mar", y: "220" }, { x: "Apr", y: "290" }, { x: "May", y: "650" }, { x: "Jun", y: "260" }, { x: "Jul", y: "274" }, { x: "Aug", y: "850" }] },
            { name: "2k", data: [{ x: "Jan", y: "750" }, { x: "Feb", y: "3350" }, { x: "Mar", y: "1220" }, { x: "Apr", y: "1290" }, { x: "May", y: "1650" }, { x: "Jun", y: "1260" }, { x: "Jul", y: "1274" }, { x: "Aug", y: "850" }] },
            { name: "3k", data: [{ x: "Jan", y: "375" }, { x: "Feb", y: "1350" }, { x: "Mar", y: "3220" }, { x: "Apr", y: "2290" }, { x: "May", y: "2650" }, { x: "Jun", y: "2260" }, { x: "Jul", y: "1274" }, { x: "Aug", y: "815" }] },
            { name: "4k", data: [{ x: "Jan", y: "575" }, { x: "Feb", y: "1350" }, { x: "Mar", y: "2220" }, { x: "Apr", y: "3290" }, { x: "May", y: "3650" }, { x: "Jun", y: "2260" }, { x: "Jul", y: "1274" }, { x: "Aug", y: "315" }] },
            { name: "5k", data: [{ x: "Jan", y: "875" }, { x: "Feb", y: "1350" }, { x: "Mar", y: "2220" }, { x: "Apr", y: "3290" }, { x: "May", y: "3650" }, { x: "Jun", y: "2260" }, { x: "Jul", y: "1274" }, { x: "Aug", y: "965" }] },
            { name: "6k", data: [{ x: "Jan", y: "575" }, { x: "Feb", y: "1350" }, { x: "Mar", y: "2220" }, { x: "Apr", y: "2290" }, { x: "May", y: "2650" }, { x: "Jun", y: "3260" }, { x: "Jul", y: "1274" }, { x: "Aug", y: "815" }] },
            { name: "7k", data: [{ x: "Jan", y: "575" }, { x: "Feb", y: "1350" }, { x: "Mar", y: "1220" }, { x: "Apr", y: "1290" }, { x: "May", y: "1650" }, { x: "Jun", y: "1260" }, { x: "Jul", y: "3274" }, { x: "Aug", y: "815" }] },
            { name: "8k", data: [{ x: "Jan", y: "575" }, { x: "Feb", y: "350" }, { x: "Mar", y: "220" }, { x: "Apr", y: "290" }, { x: "May", y: "650" }, { x: "Jun", y: "260" }, { x: "Jul", y: "274" }, { x: "Aug", y: "815" }] }
        ],
        plotOptions: {
            heatmap: {
                enableShades: !1,
    ...
    var salesAnalyticsChart = document.querySelector("#salesAnalyticsChart");
    if (salesAnalyticsChart !== null) {
        new ApexCharts(salesAnalyticsChart, c).render();
    }
}
